const { runByHBuilderX } = require("@dcloudio/uni-cli-shared");
...
async function build(args, api, options) {
  ...
  const webpackConfig = require("@vue/cli-service/lib/commands/build/resolveAppConfig")(
    api,
    args,
    options
  );
  ...
  if (process.env.NODE_ENV === "production") {
    try {
      fs.emptyDir(
        path.resolve(process.env.UNI_CLI_CONTEXT, "node_modules/.cache")
      );
    } catch (e) {}
  }
  ...
  if (
    ...
    webpackConfigs.push(
      require("@dcloudio/vue-cli-plugin-hbuilderx/build/webpack.nvue.conf.js")(
