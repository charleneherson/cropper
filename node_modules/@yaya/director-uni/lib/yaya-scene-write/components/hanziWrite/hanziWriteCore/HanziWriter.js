...
const defaultOptions = {
  ...
  checkSingleStroke: false,
  quizInterval: 1,
  keepUserStrokeAfterSuccess: false,
...
HanziWriter.prototype.quiz = function(quizOptions = {}) {
  this._withData(() => {
    this.cancelQuiz();
    this._quiz = new Quiz(this._character, this._renderState, this._positioner, this._options);
...
HanziWriter.prototype.syncUserStroke = function(externalPoints) {
  this._quiz.syncUserStroke(externalPoints)
}
...
HanziWriter.prototype.transformAxios = function(point) {
  return this._positioner.convertBackExternalPoint(point)
};
HanziWriter.prototype.convertExternalPoint = function(point) {
  return this._positioner.convertExternalPoint(point)
};
