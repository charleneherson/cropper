...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_PLATFORM":"mp-weixin","VUE_APP_BASE_HOST":"http://192.168.241.93:6009","VUE_APP_IS_ONLINE":"0","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/*!******************************************************!*\
  ...
  \******************************************************/
/*! exports provided: _args, _from, _id, _inBundle, _integrity, _location, _phantomChildren, _requested, _requiredBy, _resolved, _spec, _where, author, bugs, description, devDependencies, files, gitHead, homepage, license, main, name, repository, scripts, version, default */
/***/ (function(module) {

module.exports = {"_args":[["@dcloudio/uni-stat@2.0.0-24220191115008","/Users/Charlene/yaya/duck-chinese-minapp"]],"_from":"@dcloudio/uni-stat@2.0.0-24220191115008","_id":"@dcloudio/uni-stat@2.0.0-24220191115008","_inBundle":false,"_integrity":"sha512-g/el83JRqGkVjXuHfOp3XPMM6qob7UFWVDgNQcnjr6vXMpsFS7EDEiEsOm38OZXug1Gi3A6Fr3DAqTiRVyHRyA==","_location":"/@dcloudio/uni-stat","_phantomChildren":{},"_requested":{"type":"version","registry":true,"raw":"@dcloudio/uni-stat@2.0.0-24220191115008","name":"@dcloudio/uni-stat","escapedName":"@dcloudio%2funi-stat","scope":"@dcloudio","rawSpec":"2.0.0-24220191115008","saveSpec":null,"fetchSpec":"2.0.0-24220191115008"},"_requiredBy":["/","/@dcloudio/vue-cli-plugin-uni"],"_resolved":"http://192.168.14.11:8888/@dcloudio%2funi-stat/-/uni-stat-2.0.0-24220191115008.tgz","_spec":"2.0.0-24220191115008","_where":"/Users/Charlene/yaya/duck-chinese-minapp","author":"","bugs":{"url":"https://github.com/dcloudio/uni-app/issues"},"description":"","devDependencies":{"@babel/core":"^7.5.5","@babel/preset-env":"^7.5.5","eslint":"^6.1.0","rollup":"^1.19.3","rollup-plugin-babel":"^4.3.3","rollup-plugin-clear":"^2.0.7","rollup-plugin-commonjs":"^10.0.2","rollup-plugin-copy":"^3.1.0","rollup-plugin-eslint":"^7.0.0","rollup-plugin-json":"^4.0.0","rollup-plugin-node-resolve":"^5.2.0","rollup-plugin-replace":"^2.2.0","rollup-plugin-uglify":"^6.0.2"},"files":["dist","package.json","LICENSE"],"gitHead":"5cab4c8d18304784faaeb86fc90325c7e42bf78a","homepage":"https://github.com/dcloudio/uni-app#readme","license":"Apache-2.0","main":"dist/index.js","name":"@dcloudio/uni-stat","repository":{"type":"git","url":"git+https://github.com/dcloudio/uni-app.git","directory":"packages/uni-stat"},"scripts":{"build":"NODE_ENV=production rollup -c rollup.config.js","dev":"NODE_ENV=development rollup -w -c rollup.config.js"},"version":"2.0.0-24220191115008"};
...
var _default = {
  "pages": {
    "pages/index/index": {
      "navigationBarTitleText": "手机 sticker",
      "usingComponents": {}
    },
...
exports.getwxuser = getwxuser;

var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));
...
var appid = "wxb4d0ce9d5a7d5b8d"; // 微信登录获取code
...
function _loginbycode() {
  _loginbycode = _asyncToGenerator(
  /*#__PURE__*/
          ...
          case 0:
            promise = new Promise(function (resolve, reject) {
              login().then(function (result) {
                ...
                _request.default.get(_api.default.login.loginbycode, {
                  appid: appid,
                  code: code
                }, function (data) {
                  if (data) {
                    var wx_user = data.wx_user;
...
function getwxuser() {
  return uni.getStorageSync("wx_user") ? uni.getStorageSync("wx_user") : "";
}
...
var _login = __webpack_require__(/*! @common/js/login */ 18);

var _config = __webpack_require__(/*! @config/config */ 19);
...
function request(method, url, data, fn, fn1) {
  var reqUrl;
  url.indexOf("http") >= 0 ? reqUrl = url : reqUrl = "http://192.168.241.93:6009" + url;
  var cookie = "";
  uni.request({
    url: reqUrl,
    method: method,
    data: _objectSpread({}, data, {
      minivc: _config.minivc,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.t0 = res.data.errNo;
                _context.next = _context.t0 === 0 ? 4 : _context.t0 === 3 ? 6 : _context.t0 === 99 ? 8 : 13;
                break;
...
var _default = {
  get: function get(url) {
    ...
    var fn1 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function () {};
  ...
  pro_post: function pro_post(url) {
    var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return new Promise(function (resolve, reject) {
...
exports.getwxuid = getwxuid;
exports.getzybuss = getzybuss;
exports.setzybuss = setzybuss;
...
var _wxlogin = __webpack_require__(/*! ./wxlogin.js */ 12);
...
var appid = "wxb4d0ce9d5a7d5b8d";
var suffix = Number("0") ? "prod" : "dev";
console.log(Number("0"), "0");
var zybussKey = "zybuss-" + suffix; // 获得手机号登录换取zybuss、wx_uid
...
function _login() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(encryptedData, iv) {
    var wx_user, promise;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            wx_user = (0, _wxlogin.getwxuser)();
            promise = new Promise(function (resolve, reject) {
              if (wx_user) {
                _request.default.post(_api.default.login.login, {
                  appid: appid,
                  wx_user: wx_user,
                  encryptedData: encryptedData,
                  iv: encodeURIComponent(iv)
                }, function (_ref) {
                  var wx_uid = _ref.wx_uid,
                      zybuss = _ref.zybuss;
...
function _updatelogin() {
  _updatelogin = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            promise = new Promise(function (resolve, reject) {
              var zybuss = getzybuss();
              var wx_user = (0, _wxlogin.getwxuser)();

              if (zybuss && wx_user) {
                _request.default.post(_api.default.login.getuserstatus, {
                  appid: appid,
                  wx_user: wx_user
                }, function (res) {
                  // 没有登录
...
function getzybuss() {
  return uni.getStorageSync(zybussKey) ? uni.getStorageSync(zybussKey) : "";
} //设置zybuss
...
function getwxuid() {
  return uni.getStorageSync("wx_uid") ? uni.getStorageSync("wx_uid") : "";
} //设置wx_uid
...
exports.minivc = exports.product_secret = exports.product_appid = exports.appid = void 0;
var appid = "wxb4d0ce9d5a7d5b8d";
exports.appid = appid;
var product_appid = "222";
exports.product_appid = product_appid;
var product_secret = "9b3a1fcf65096258cb4c7e81b4fd598c";
exports.product_secret = product_secret;
var minivc = "1.0.10";
exports.minivc = minivc;

/***/ }),
/* 20 */
/*!************************************!*\
  !*** ./src/common/js/load-font.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function LoadFont() {
  var FontsSet = {
    DIN: "https://zyb-yayayuwen-1253445850.cos.ap-beijing.myqcloud.com/yaya-fe/fonts/DIN%20Alternate%20Bold.min.ttf",
    FANGZHENG: "https://zyb-yayayuwen-1253445850.cos.ap-beijing.myqcloud.com/yaya-fe/study-report/fzltyjc.TTF"
  };
  console.log("Can I Use LoadFontFace ? ".concat(wx.canIUse("loadFontFace")));
  wx.loadFontFace({
    global: true,
    family: "DIN",
    source: "url(\"".concat(FontsSet.DIN, "\")"),
    success: function success(res) {
      console.log("Successed Load FontFace [DIN], ".concat(JSON.stringify(res)));
    },
    fail: function fail(res) {
      console.log("Failed Load FontFace [DIN], ".concat(JSON.stringify(res)));
    },
    complete: function complete(res) {
      console.log("Completed Load FontFace [DIN], ".concat(JSON.stringify(res)));
    }
  });
}
